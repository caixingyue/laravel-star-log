...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('starlog.device', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('starlog.platform', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('starlog.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('starlog.desktop', function () {
